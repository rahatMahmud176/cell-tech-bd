                                    ...
                                    <div class="row">
                                            ...
                                            <div class="single-form form-default">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 form-input form">
                                                        <input name="first_name" required maxlength="30" type="text"
                                                            value="{{ Session::get('customerFirstName') }}">
                                                    </div>
                                                    <div class="col-md-6 form-input form">
                                                        <input name="last_name" maxlength="30" required type="text"
                                        ...
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                ...
                                                <div class="form-input form">
                                                    <input name="phone_number" required type="tel" maxlength="11"
                                                        minlength="11" value="{{ $customerInfo->phone_number }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                ...
                                                <div class="form-input form">
                                                    <input name="district" required maxlength="30" type="text"
                                        ...
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                ...
                                                <div class="form-input form">
                                                    <input name="upozilla" maxlength="30" type="text"
                                                        placeholder="Input your Upozilla or Area name">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="single-form form-default">
                                                ...
                                                <div class="form-input form">
                                                    <textarea name="description" maxlength="250" id="" cols="30" rows="10"
                                                        placeholder="Importent note here"></textarea>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="checkout-sidebar-price-table ">
                            ...
                            <div class="sub-total-price">
                                ...
                                <div class="total-price">
                                    ...
                                    <p class="price"> <span>(-)</span> {{ $advance = Session::get('advance_amount') }}\-
                                    </p>
                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input name="deu_amount" disabled readonly type="" class="form-control"
                            id="formGroupExampleInput" placeholder="{{ Cart::getSubTotal() }}">
                    </div>
                    <div class="form-group">
                        <label for="formGroupExampleInput">Advance Amount</label>
                        <input name="advance_amount" required max="{{ Cart::getSubTotal() }}" type="number"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" required maxlength="30" name="transition_id" class="form-control"
