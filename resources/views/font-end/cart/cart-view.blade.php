                ...
                @foreach ($products as $item)
                    <div class="cart-single-list">
                        <div class="row align-items-center">
                            <div class="col-lg-1 col-md-1 col-12">
                                <a href="product-details.html"><img src="{{ asset($item->attributes->image) }}"
                                        alt="#"></a>
                            </div>
                            <div class="col-lg-4 col-md-3 col-12">
                                ...
                                <p class="product-des">
                                    <span><em>Variant:</em>
                                        {{ App\Models\Size::find($item->attributes->size_id)->title }}</span>
                                    <span><em>Color:</em>
                                        {{ App\Models\Color::find($item->attributes->color_id)->title }}</span>
                                </p>
                            </div>
                            <div class="col-lg-2 col-md-2 col-12">
                            ...
                            <div class="col-lg-1 col-md-2 col-12">
                                <a class="remove-item" href="{{ route('remove-cart-product', ['id' => $item->id]) }}"><i
