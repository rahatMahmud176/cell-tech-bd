...
<img src="{{ asset('/') }}cell-tech-logo-removebg-preview.png"  style="width: 70px" alt="Logo">
</a>
...
<a class="cart-img" href="product-details.html"><img src="{{ asset('/') }}font-end/assets/images/header/cart-items/item1.jpg" alt="#"></a>
</div>
<div class="content">
...
<a href="javascript:void(0)" class="remove" title="Remove this item"><i class="lni lni-close"></i></a>
<div class="cart-img-head">
<a class="cart-img" href="product-details.html"><img src="{{ asset('/') }}font-end/assets/images/header/cart-items/item2.jpg" alt="#"></a>
</div>
<div class="content">
