<footer class="footer">
    ...
    <a href="index.html">
    <img src="{{ asset('/') }}font-end/assets/images/logo/white-logo.svg" alt="#">
    </a>
    </div>
    </div>
    ...
    <span>We Accept:</span>
    <img src="{{ asset('/') }}font-end/assets/images/footer/credit-cards-footer.png" alt="#">
    </div>
    </div>
    <div class="col-lg-4 col-12">
    <div class="copyright">
    <p>Designed and Developed by<a href="#" rel="nofollow" target="_blank">MD Rahat Mahmud</a></p>
    </div>
    </div>
    <div class="col-lg-4 col-12">
    <ul class="socila">
