<section class="special-offer section">
    ...
    <div class="single-product">
    <div class="product-image">
    <img src="{{ asset('/') }}font-end/assets/images/products/product-8.jpg" alt="#">
    <div class="button">
    <a href="product-details.html" class="btn"><i class="lni lni-cart"></i> Add to
    Cart</a>
    </div>
    ...
    <div class="single-product">
    <div class="product-image">
    <img src="{{ asset('/') }}font-end/assets/images/products/product-6.jpg" alt="#">
    <div class="button">
    <a href="product-details.html" class="btn"><i class="lni lni-cart"></i> Add to
    Cart</a>
    </div>
    ...
    <div class="single-banner right" style="background-image:url('{{ asset('/') }}font-end/assets/images/banner/banner-3-bg.jpg');margin-top: 30px;">
    <div class="content">
