...
@section('title')
   Special offer Special offer Banner Manage
@endsection
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="card-title">Special Offer Banner Edit Form:-</h4>  
    
                {{ Form::open(['route'=>['spoBanner.update',$banner->id],'method'=>'POST','class'=>'custom-validation','enctype'=>'multipart/form-data']) }}
                @method('PUT')
                ...
                <div class="mt-3">
                    ...
                    <input type="text" required maxlength="30" name="header" class="form-control" id="thresholdconfig" value="{{ $banner->header }}" />
                </div>   
