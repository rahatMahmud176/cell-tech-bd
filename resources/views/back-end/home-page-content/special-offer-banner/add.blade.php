        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">Special offer Banner Manage</h4>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="">
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a class="dropdown-item" href="{{ route('spoBanner-status-change',['id'=>$item->id]) }}">{{ $item->status==1?'Pused':'Resume' }}</a>
                                                            <a class="dropdown-item" href="{{ route('spoBanner.edit',$item->id) }}">Edit</a>
                                                            <a class="dropdown-item" href="{{ route('spoBanner.deleteAlert',['id'=>$item->id]) }}">Delete</a> 
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                ...
                {{ Form::open(['route'=>'spoBanner.store','method'=>'POST','class'=>'custom-validation','enctype'=>'multipart/form-data']) }}
