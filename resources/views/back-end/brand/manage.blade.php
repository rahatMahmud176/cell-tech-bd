                                    ...
                                    <table class="table project-list-table table-nowrap table-centered table-borderless">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><span class="badge badge-success">{{ $item->category->title }}</span></td>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <a class="dropdown-item" href="{{ route('brand.deleteAlert',['id'=>$item->id]) }}">Delete</a> 
                                                            <a class="dropdown-item" href="{{ route('brand.edit',$item->id) }}">Status change</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                ...
                {{ Form::open(['route'=>'brand.store','method'=>'POST','class'=>'custom-validation','enctype'=>'multipart/form-data']) }}
